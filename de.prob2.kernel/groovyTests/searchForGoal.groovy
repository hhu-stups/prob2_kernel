...
final res1 = new ConsistencyChecker(s, new ModelCheckingOptions().customGoal("card(waiting) = 2" as ClassicalB)).call()
...
try {
	new ConsistencyChecker(s, new ModelCheckingOptions().customGoal("1" as ClassicalB)).call()
