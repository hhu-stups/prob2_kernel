...
public class TraceMetaClass extends DelegatingMetaClass {
	public TraceMetaClass(MetaClass delegate) {
		super(delegate);
	}

	public TraceMetaClass(Class<?> theClass) {
		super(theClass);
	}
	...
	public Object invokeMethod(Object object, String methodName, Object[] arguments) {
		try {
			...
			return trace.execute(methodName, preds);
		}
	}
}
