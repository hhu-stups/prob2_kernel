...
public class TypedOperationInfo {
	...
	public enum Type {
		...
		public static Type fromProlog(final String prologName) {
			switch (prologName) {
				case "classic":
					return CLASSICAL_B;
	...
	public TypedOperationInfo(
			...
			@JsonProperty("typeInfos") final Map<String, String> typeInfo
	) {
