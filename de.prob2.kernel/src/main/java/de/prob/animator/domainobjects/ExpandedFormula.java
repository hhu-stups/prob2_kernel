	...
	ExpandedFormula(final ExpandedFormula.Builder builder) {
		...
		if (builder.children != null) {
			...
			if (builder.subformulas == null) {
				throw new IllegalArgumentException("Missing required field: children or subformulas");
			}
		...
		public static ExpandedFormula.ProofInfo fromPrologTerm(final PrologTerm term) {
			...
			for (final PrologTerm entryTerm : BindingGenerator.getList(term)) {
				...
				switch (entry.getArgument(1).atomToString()) {
					case "unchanged":
						unchangedCount = BindingGenerator.getAInteger(entry.getArgument(2)).intValueExact();
						break;

					case "proven":
						provenCount = BindingGenerator.getAInteger(entry.getArgument(2)).intValueExact();
						break;

					case "unproven":
						unprovenCount = BindingGenerator.getAInteger(entry.getArgument(2)).intValueExact();
						break;
	...
	public static final class Builder {
		...
		public ExpandedFormula.Builder formula(final BVisual2Formula formula) {
			...
			if (this.formula != null) {
				throw new IllegalStateException("formula already set, current='" + this.formula + "', new='" + formula + "'");
			}
		...
		public ExpandedFormula.Builder label(final String label) {
			...
			if (this.label != null) {
				throw new IllegalStateException("label already set, current='" + this.label + "', new='" + label + "'");
			}
			this.label = label;
			return this;
		}
		...
		public ExpandedFormula.Builder description(final String description) {
			...
			if (this.description != null) {
				throw new IllegalStateException("description already set, current='" + this.description + "', new='" + description + "'");
			}
		...
		public ExpandedFormula.Builder proofInfo(final ExpandedFormula.ProofInfo proofInfo) {
			Objects.requireNonNull(proofInfo, "proofInfo");
			if (this.proofInfo != null) {
				throw new IllegalStateException("proofInfo already set, current='" + this.proofInfo + "', new='" + proofInfo + "'");
			}
		...
		public ExpandedFormula.Builder functorSymbol(final String functorSymbol) {
			Objects.requireNonNull(functorSymbol, "functorSymbol");
			if (this.functorSymbol != null) {
				throw new IllegalStateException("functorSymbol already set, current='" + this.functorSymbol + "', new='" + functorSymbol + "'");
			}
		...
		public ExpandedFormula.Builder rodinLabels(final List<String> rodinLabels) {
			Objects.requireNonNull(rodinLabels, "rodinLabels");
			if (this.rodinLabels != null) {
				throw new IllegalStateException("rodinLabels already set, current='" + this.rodinLabels + "', new=" + rodinLabels + "'");
			}
		...
		public ExpandedFormula.Builder value(final BVisual2Value value) {
			...
			if (this.value != null) {
				throw new IllegalStateException("value already set, current='" + this.value + "', new=" + value + "'");
			}
			this.value = value;
			return this;
		}
		...
		public ExpandedFormula.Builder type(final ExpandedFormula.FormulaType type) {
			...
			if (this.type != null) {
				throw new IllegalStateException("type already set, current='" + this.type + "', new=" + type + "'");
			}
			this.type = type;
			return this;
		}
		...
		public ExpandedFormula.Builder subformulas(final List<BVisual2Formula> subformulas) {
			Objects.requireNonNull(subformulas, "subformulas");
			if (this.subformulas != null) {
				throw new IllegalStateException("subformulas already set, current='" + this.subformulas + "', new=" + subformulas + "'");
			} else if (this.children != null) {
				throw new IllegalStateException("Cannot set both children and subformulas, current='" + this.children + "', new=" + subformulas + "'");
			}
		...
		public ExpandedFormula.Builder children(final List<ExpandedFormula> children) {
			...
			if (this.children != null) {
				throw new IllegalStateException("children already set, current='" + this.children + "', new=" + children + "'");
			} else if (this.subformulas != null) {
				throw new IllegalStateException("Cannot set both subformulas and children, current='" + this.subformulas + "', new=" + children + "'");
			}
