...
public class BLibrary {
	 ...
	 */
	public void updateComponentAmount(
		final LibraryComponentName libraryComponentName,
		final int addAmount
	) {
	...
	private void updateComponentAmount(
		final Set<LibraryComponent> components,
	...
	private void setComponentAmount(
		final Set<LibraryComponent> components,
		final LibraryComponent libraryComponent,
		final int amount
	) {
	 ...
	 * exist.
	 */
	private void addComponentOrIncreaseAmount(
		final Set<LibraryComponent> components,
		final LibraryComponent libraryComponent
	) {
		final Optional<LibraryComponent> optionalLibraryComponent = components.stream()
