...
public class GetPlantUmlForVisualizationCommand extends AbstractCommand {
	private static final String PROLOG_COMMAND_NAME = "call_plantuml_command_in_state";
	...
	public GetPlantUmlForVisualizationCommand(final State id, DynamicCommandItem item, File file, List<IEvalElement> formulas) {
		this.id = id;
		this.item = item;
		this.file = file;
